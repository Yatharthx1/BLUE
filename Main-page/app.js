...
const PROFILE_PARAMS = {
  drinking: [
    ...
    { id: 'Ammonia',         label: 'Ammonia',           unit: 'mg/L as NH3-N' },
    { id: 'Selenium',        label: 'Selenium',          unit: 'mg/L' },
    { id: 'pH',              label: 'pH',                unit: '' },
    ...
    { id: 'Manganese',       label: 'Manganese',         unit: 'mg/L' },
  ...
  agriculture: [
    ...
    { id: 'Iron',        label: 'Iron',        unit: 'mg/L' },
    { id: 'Manganese',   label: 'Manganese',   unit: 'mg/L' },
    { id: 'Zinc',        label: 'Zinc',        unit: 'mg/L' },
    { id: 'Copper',      label: 'Copper',      unit: 'mg/L' },
    { id: 'Fluoride',    label: 'Fluoride',    unit: 'mg/L' },
    { id: 'Arsenic',     label: 'Arsenic',     unit: 'mg/L' },
    { id: 'Cadmium',     label: 'Cadmium',     unit: 'mg/L' },
    { id: 'Lead',        label: 'Lead',        unit: 'mg/L' },
    { id: 'Mercury',     label: 'Mercury',     unit: 'mg/L' },
    { id: 'Selenium',    label: 'Selenium',    unit: 'mg/L' },
  ],
  industrial: [
    { id: 'pH',         label: 'pH',                unit: '' },
    ...
    { id: 'Oil_Grease', label: 'Oil & Grease',      unit: 'mg/L' },
    { id: 'Phosphate',  label: 'Phosphate',         unit: 'mg/L as PO4' },
    { id: 'Zinc',       label: 'Zinc',              unit: 'mg/L' },
  ],
  aquaculture: [
    { id: 'pH',          label: 'pH',          unit: '' },
    ...
    { id: 'H2S',         label: 'H2S',               unit: 'mg/L' },
    { id: 'Chlorine',    label: 'Chlorine',          unit: 'mg/L (free residual)' },
    { id: 'Copper',      label: 'Copper',            unit: 'mg/L' },
    { id: 'Zinc',        label: 'Zinc',              unit: 'mg/L' },
    { id: 'Mercury',     label: 'Mercury',           unit: 'mg/L' },
    { id: 'Arsenic',     label: 'Arsenic',           unit: 'mg/L' },
